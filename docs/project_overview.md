...
![gold.fact_sales](https://img.shields.io/badge/gold.dim_sales-grey?style=flat-square): Transaction-level sales data

<h3> Dimension Tables </h3>

![gold.dim_products](https://img.shields.io/badge/gold.dim_products-grey?style=flat-square): Product details, categories, costs

![gold.dim_customers](https://img.shields.io/badge/gold.dim_customers-grey?style=flat-square): Customer demographics and attributes
...
<h3> 4.1 Exploratory Data Analysis (EDA) </h3>
...
<h3> 4.3 BI-Ready Reporting Views </h3>
...
2) BI Developers
3) Data Engineers
4) Students learning SQL analytics
5) Anyone building analytics projects with SQL
